...
const initDB = async () => {
  ...
  // سياسة الملكية الفكرية — نص ابتدائي قابل للتحرير من لوحة التحكم
  await pool.query(`
    INSERT INTO site_settings (key, value) VALUES
      ('intellectual_property_policy', '<h2>1. استقلالية المنصة</h2>
<p>حل مدرستي منصة تعليمية مستقلة، لا تتبع وزارة التعليم في المملكة العربية السعودية ولا تمثّلها ولا تنوب عنها، وليست جهة رسمية أو معتمدة منها.</p>

<h2>2. ملكية المناهج الرسمية</h2>
<p>المناهج والكتب الدراسية وأدلة المعلم وجميع المواد التعليمية الرسمية ملك لوزارة التعليم، وحقوق طبعها ونشرها محفوظة لها وحدها. لا ندّعي ملكية أيٍّ منها، ولا نمنح غيرنا حق استخدامها.</p>

<h2>3. طبيعة ما تعرضه المنصة</h2>
<p>ما ننشره من حلول وملخصات وشروح هو جهد تعليمي مساعد يهدف لتيسير الفهم والمراجعة على الطلاب، ولا يغني عن الكتاب المدرسي ولا يُعدّ بديلاً معتمداً عنه.</p>

<h2>4. المصادر وحقوق الغير</h2>
<p>بعض الملفات المنشورة تعود لجهات أو منصات تعليمية أخرى، ونذكر مصدرها عند توفره. الحقوق في هذه الحالة تبقى لأصحابها.</p>

<h2>5. المحتوى الذي نُعدّه</h2>
<p>التصميم والترتيب والشروح والاختبارات التفاعلية التي تُعدّها المنصة هي من إنتاجنا، ويُمنع نسخها أو إعادة نشرها تجارياً دون إذن كتابي.</p>

<h2>6. الاستخدام المسموح</h2>
<p>يحق للطالب وولي الأمر والمعلم استخدام المحتوى للأغراض التعليمية الشخصية. ولا يجوز إعادة بيعه أو نشره في مواقع أو قنوات أخرى ونسبته لناشرها.</p>

<h2>7. الإبلاغ وطلب الإزالة</h2>
<p>إن كنت صاحب حق وترى أن محتوى منشوراً لدينا يمسّ حقوقك، راسلنا عبر <a href="/contact">صفحة اتصل بنا</a> موضحاً رابط المحتوى وصفة الحق ووسيلة تواصل، ونلتزم بمراجعة البلاغ وإزالة المحتوى إن ثبت ذلك.</p>

<h2>8. تحديث السياسة</h2>
<p>قد تُحدَّث هذه السياسة من وقت لآخر، ويسري التحديث من تاريخ نشره على هذه الصفحة.</p>')
    ON CONFLICT (key) DO NOTHING
  `);
